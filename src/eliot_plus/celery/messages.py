...
CelerySignalSenderField = eliot.Field(
    'sender',
    extract_sender,
)
...
CelerySignalParentActionField = eliot.Field(
    'parent_action_uuid',
    extract_action,
)
...
CelerySignalTaskInfoField = eliot.Field(
    'celery_info',
    extract_celery_info,
)
...
def start_celery_task(**kwargs):
    ...
    if local_action:
        task_kwargs['eliot_parent_uuid'] = local_action.serialize_task_id().decode('ascii')
...
CeleryQueuedSignal = eliot.MessageType(
    'celery:task:started',
    [],
)


CeleryStartedSignal = eliot.MessageType(
    'celery:task:started',
    [],
)


CeleryCompletedSignal = eliot.MessageType(
    'celery:task:completed',
    [],
)


CeleryFailedSignal = eliot.MessageType(
    'celery:task:failed',
    [],
)
