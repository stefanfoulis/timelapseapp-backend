    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original', models.ImageField(blank=True, db_index=True, default='', max_length=255, null=True, storage=timelapse_manager.storage.dsn_configured_storage('TIMELAPSE_STORAGE_DSN'), upload_to='')),
                ('original_md5', models.CharField(blank=True, db_index=True, default='', max_length=32)),
                ('scaled_at_160x120', models.ImageField(blank=True, db_index=True, default='', max_length=255, null=True, storage=timelapse_manager.storage.dsn_configured_storage('TIMELAPSE_STORAGE_DSN'), upload_to=functools.partial(timelapse_manager.storage.upload_to_thumbnail, *(), **{'size': '160x120'}))),
                ('scaled_at_160x120_md5', models.CharField(blank=True, db_index=True, default='', max_length=32)),
                ('scaled_at_320x240', models.ImageField(blank=True, db_index=True, default='', max_length=255, null=True, storage=timelapse_manager.storage.dsn_configured_storage('TIMELAPSE_STORAGE_DSN'), upload_to=functools.partial(timelapse_manager.storage.upload_to_thumbnail, *(), **{'size': '320x240'}))),
                ('scaled_at_320x240_md5', models.CharField(blank=True, db_index=True, default='', max_length=32)),
                ('scaled_at_640x480', models.ImageField(blank=True, db_index=True, default='', max_length=255, null=True, storage=timelapse_manager.storage.dsn_configured_storage('TIMELAPSE_STORAGE_DSN'), upload_to=functools.partial(timelapse_manager.storage.upload_to_thumbnail, *(), **{'size': '640x480'}))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, db_index=True, default='', max_length=255, null=True, storage=timelapse_manager.storage.dsn_configured_storage('TIMELAPSE_STORAGE_DSN'), upload_to=timelapse_manager.storage.upload_to_movie_rendering)),
